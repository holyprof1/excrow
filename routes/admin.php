...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        //Cookie
        Route::get('gdpr-content/{key}', 'FrontendController@frontendSections')->name('setting.cookie');

        //maintenance_mode
        Route::get('maintenance-content/{key}', 'FrontendController@frontendSections')->name('maintenance.mode');
    });
