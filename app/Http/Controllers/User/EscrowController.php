...
class EscrowController extends Controller {
    ...
    public function index($type = null) {
        ...
        return view($this->activeTemplate . 'user.escrow.index', compact('pageTitle', 'escrows'));
    }

    public function stepOne() {
        $pageTitle = "New Escrow - Step One";
        return view($this->activeTemplate . 'user.escrow.step_one', compact('pageTitle'));
    }
    ...
    public function stepTwo() {
        ...
        return view($this->activeTemplate . 'user.escrow.step_two', compact('pageTitle', 'escrowInfo'));
    }
    ...
    public function details($id) {
        ...
        return view($this->activeTemplate . 'user.escrow.details', compact('pageTitle', 'escrow', 'conversation', 'messages'));
    }
