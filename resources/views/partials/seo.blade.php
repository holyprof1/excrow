@if ($seo)
    <meta name="title"
        Content="{{ @$seoContents['title'] ? $seoContents['title'] : $general->siteName(__($pageTitle)) }}">
    ...
    <meta name="apple-mobile-web-app-title"
        content="{{ @$seoContents['title'] ? $seoContents['title'] : $general->siteName($pageTitle) }}">
    {{-- <!-- Google / Search Engine Tags --> --}}
    <meta itemprop="name"
        content="{{ @$seoContents['title'] ? $seoContents['title'] : $general->siteName($pageTitle) }}">
    <meta itemprop="description"
        content="{{ @$seoContents['description'] ? $seoContents['description'] : $general->seo_description }}">
    <meta itemprop="image" content="{{ getImage(getFilePath('seo') . '/' . $seo->image) }}">
    {{-- <!-- Facebook Meta Tags --> --}}
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ @$seoContents['title'] ? $seoContents['title'] : $seo->social_title }}">
