                            ...
                            <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 form-group">
                                        ...
                                        <textarea name="message" id="inputMessage" class="form-control form--control-textarea" required>{{ old('message') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn--base w-100 h-45" type="submit"><i
