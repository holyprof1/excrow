                            ...
                            <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                                ...
                                <div class="text-end">
                                    <a href="javascript:void(0)" class="btn btn--base btn-sm addFile">
                                        <i class="la la-plus"></i> @lang('Add More Attachments')
                                    </a>
                                </div>
                                <div class="form-group ">
                                ...
                                <button type="submit" class="btn btn--base h-45 w-100"> <i class="las  la-reply"></i>
                                    @lang('Reply')</button>
                            </form>
                        </div>
                    </div>
...
@push('script')
    <script>
        (function($) {
            ...
            $('.btn--primary').removeClass('btn--primary').addClass('btn--base');
        })(jQuery);
    </script>
@endpush
