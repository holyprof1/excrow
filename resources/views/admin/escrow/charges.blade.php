                            ...
                            <tbody>
                                @forelse($charges as $charge)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn" data-resource="{{ $charge }}" data-modal_title="@lang('Update Charge Range')" data-has_status="1">
                                                <i class="la la-pencil"></i>@lang('Edit')
                                            </button>

                                            <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn" data-question="@lang('Are you sure to remove this charge range?')" data-action="{{ route('admin.charge.remove', $charge->id) }}">
