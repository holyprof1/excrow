    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.escrow*', 3) }}">
                        <i class="menu-icon las la-handshake"></i>
                        <span class="menu-title">@lang('Manage Escrow')</span>
                        @if (0 < $disputedEscrowCount)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.charge.index') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.maintenance.mode') }}">
                    <a href="{{ route('admin.maintenance.mode', 'maintenance_mode') }}" class="nav-link">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.cookie') }}">
                    <a href="{{ route('admin.setting.cookie', 'gdpr_cookie_policy') }}" class="nav-link">
