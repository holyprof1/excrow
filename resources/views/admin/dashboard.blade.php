...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.deposit.list') }}" icon="fas fa-percentage" icon_style="false"
                title="Deposited Charge" value="{{ $general->cur_sym }}{{ showAmount($deposit['total_deposit_charge']) }}"
                color="primary" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="2" link="{{ route('admin.withdraw.log') }}" icon="lar la-credit-card"
                ...
                value="{{ $general->cur_sym }}{{ showAmount($withdrawals['total_withdraw_amount']) }}" color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.escrow.index') }}" icon="fa fa-hand-holding-usd"
                title="Total Escrowed Amount" value="{{ $general->cur_sym }}{{ showAmount($dataEscrow['total']) }}"
                bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.escrow.completed') }}" icon="fa fa-file-invoice-dollar"
                title="Escrowed Funded" value="{{ $general->cur_sym }}{{ showAmount($dataEscrow['funded']) }}"
                bg="1" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.escrow.canceled') }}" icon="fa fa-times-circle"
                title="Canceled Escrow" value="{{ $general->cur_sym }}{{ showAmount($dataEscrow['cancelled']) }}"
                bg="14" />

        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.escrow.disputed') }}" icon="fa fa-spinner"
                title="Disputed Escrow" value="{{ $general->cur_sym }}{{ showAmount($dataEscrow['disputed']) }}"
                bg="19" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
