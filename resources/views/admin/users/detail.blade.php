        ...
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" bg="white" color="info" icon="las la-money-bill-wave-alt" title="Balance" value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="success" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" icon="las la-wallet" title="Deposited" value="{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" bg="white" color="warning" link="{{ route('admin.withdraw.log') }}?search={{ $user->username }}" icon="la la-wallet" title="Withdrawan" value="{{ $general->cur_sym }}{{ showAmount($totalWithdrawals) }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-exchange-alt" title="Transactions" value="{{ $totalTransaction }}" icon_style="solid" overlay_icon="0" />
                </div>
            </div>

            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="primary" icon="la la-hand-holding-usd" title="Milestone Funded" value="{{ $general->cur_sym }}{{ showAmount($data['milestoneFunded']) }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="info" icon="la las la-handshake" title="Total Escrow" value="{{ $data['totalEscrow'] }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" icon="las la-running" color="success" title="Running Escrow" value="{{ $data['accepted'] }}" icon_style="solid" overlay_icon="0" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="warning" icon="la la-spinner" title="Awaiting for Accept" value="{{ $data['notAccepted'] }}" icon_style="solid" overlay_icon="0" />
                </div>
            </div><!-- row end-->

            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="success" icon="la la-check" title="Completed Escrow" value="{{ $data['completed'] }}" icon_style="solid" overlay_icon="0" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="5" icon="las la-ban" title="Disputed Escrow" value="{{ $data['disputed'] }}" icon_style="solid" overlay_icon="0" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="danger" icon="la la-times-circle" title="Canceled Escrow" value="{{ $data['cancelled'] }}" icon_style="solid" overlay_icon="0" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="2" color="6" icon="la la-ticket-alt" title="Total Ticket" value="{{ $data['ticket'] }}" icon_style="solid" overlay_icon="0" />
                </div>
            </div><!-- row end-->
