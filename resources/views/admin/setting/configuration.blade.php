                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span>
                                            @lang('module, users must have to submit') <a href="{{ route('admin.kyc.setting') }}">@lang('the required data')</a>.
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Maintenance Mode')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, vistors/users can\'t visit the frontend/website')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="maintenance_mode" @if ($general->maintenance_mode) checked @endif>
                                </div>
                            </li>

                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('GDPR Cookie')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can see the gdpr cookie policy popup.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="gdpr_cookie" @if ($general->gdpr_cookie) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
